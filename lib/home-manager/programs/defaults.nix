# https://github.com/sudosubin/nixos-config/blob/522697876ef98ead695d21de8fb2f4e4a40c36a8/libraries/home-manager/programs/defaults/default.nix
{
  config,
  pkgs,
  lib,
...
with lib; let
  ...
  writeValue = value:
    ...
    then "-float ${strings.floatToString value}"
